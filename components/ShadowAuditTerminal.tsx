          ...
          <div className="order-1 lg:order-2">
            <Reveal>
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 rounded-2xl cyber-glass-light flex items-center justify-center text-brand-orange">
                  <Cpu className="w-6 h-6" />
                </div>
                <span className="font-mono text-brand-orange uppercase tracking-[0.4em] text-xs italic font-bold">Protocol 4.2.0</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-bold mb-8 tracking-tighter leading-tight text-slate-900">
                Live <br /><span className="text-slate-500 italic">Neural Scans.</span>
              </h2>
              <p className="text-slate-500 text-lg mb-10 leading-relaxed tracking-tight max-w-lg">
              ...
              <div className="space-y-6">
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col sm:flex-row gap-4 p-2 bg-slate-100/50 border border-slate-200 rounded-3xl cyber-glass-light shadow-inner group">
                    <div className="flex-1 flex items-center gap-4 px-6 py-4">
                      ...
                      <input
                        ...
                        className="bg-transparent border-none outline-none text-slate-900 w-full text-lg font-mono placeholder:text-slate-400 tracking-tight"
                      />
                    </div>
                    <button
                      onClick={startAudit}
                      disabled={status === 'scanning'}
                      className="tactile-btn bg-slate-900 text-white px-10 py-4 rounded-2xl font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-3 whitespace-nowrap"
                    >
                      {status === 'scanning' ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Zap className="w-5 h-5 fill-white" /> Init Scan</>}
                    </button>
                  </div>
