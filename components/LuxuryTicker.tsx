...
const LuxuryTicker: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-[#FAFAFA] overflow-hidden border-t-[0.5px] border-b-[0.5px] border-slate-200 py-4 select-none">
        ...
        <div className="flex animate-marquee hover:[animation-play-state:paused]">
          {items.map((text, i) => (
            <div key={i} className="flex items-center mx-10">
              <span className="text-[10px] md:text-xs font-sans font-medium uppercase tracking-[0.4em] text-slate-400">
                <span className="text-slate-700 font-bold">A B2</span> COMPANIES VENTURE
              </span>
              <span className="mx-6 text-slate-300 font-light">|</span>
              <span className="text-[10px] md:text-xs font-sans font-medium uppercase tracking-[0.4em] text-[#C5A059]/80">
