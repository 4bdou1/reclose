...
const HowWeWork: React.FC = () => {
  return (
    <section id="how-we-work" className="bg-transparent py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-0.5 bg-white/10 transform md:-translate-x-1/2" />
              ...
              {steps.map((step, index) => (
                <Reveal key={step.id} delay={index * 150}>
                  <div className={`relative flex flex-col md:flex-row items-center gap-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    {/* Icon Bubble */}
                    <div className="absolute left-6 md:left-1/2 w-12 h-12 rounded-full bg-black text-[#D6B36B] flex items-center justify-center transform -translate-x-1/2 border-4 border-[#050505] shadow-sm z-10">
