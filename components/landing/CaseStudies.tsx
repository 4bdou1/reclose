    ...
    <section id="work" className="bg-transparent py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          ...
          <Reveal delay={200}>
            <a href="#get-started" className="hidden md:inline-flex items-center gap-2 text-sm font-semibold text-white hover:text-[#ba8c2c] transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <Reveal key={project.title} delay={index * 150} width="100%">
              <div className="group cursor-pointer relative overflow-hidden rounded-[2rem] border border-gray-800 bg-[#0a0a0a] shadow-sm transition-all hover:shadow-xl hover:-translate-y-1">
                {/* Visual Placeholder */}
                <div className={`h-64 w-full bg-gradient-to-br ${project.gradient} flex items-center justify-center p-8`}>
                  <div className="w-full h-full bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl shadow-sm flex items-center justify-center">
                    <span className="text-gray-500 font-medium tracking-widest uppercase text-sm">Project Visual</span>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                  </div>
